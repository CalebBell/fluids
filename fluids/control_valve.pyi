...
def control_valve_choke_P_g(xT: int, gamma: float, P1: Optional[float] = ..., P2: Optional[float] = ...) -> float: ...
...
def size_control_valve_g(
    ...
    allow_laminar: bool = ...,
    full_output: bool = ...
) -> Union[Dict[str, Optional[Union[bool, float]]], Dict[str, Optional[Union[float, bool, str]]], float]: ...
