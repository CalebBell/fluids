...
def cdf_Rosin_Rammler(d: float, k: int, m: int) -> float: ...
...
def pdf_Rosin_Rammler(d: float, k: int, m: int) -> float: ...


def pdf_Rosin_Rammler_basis_integral(d: float, k: int, m: int, n: int) -> float: ...
