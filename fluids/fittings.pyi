...
def Miller_bend_unimpeded_correction(Kb: float, Di: float, L_unimpeded: float) -> Union[float64, float]: ...
...
def contraction_beveled(Di1: float, Di2: float, l: Optional[float] = ..., angle: Optional[int] = ...) -> float: ...
...
def diffuser_sharp(Di1: float, Di2: int) -> float: ...


def entrance_angled(angle: int, method: str = ...) -> float: ...


def entrance_beveled(Di: float, l: float, angle: int, method: str = ...) -> float: ...
