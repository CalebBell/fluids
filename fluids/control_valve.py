...
def size_l(rho, Psat, Pc, mu, P1, P2, Q, D1, D2, d, FL, Fd):
    ...
    >>> size_l(rho=965.4, Psat=70.1E3, Pc=22120E3, mu=3.1472E-4,
    ...
    >>> size_l(rho=965.4, Psat=70.1E3, Pc=22120E3, mu=3.1472E-4, P1=680E3,
    ... P2=220E3, Q=0.1, D1=0.1, D2=0.09, d=0.08, FL=0.9, Fd=0.46)
    177.44417090966715

    Modified example 2 with non-choked flow, with reducer and expander

    >>> size_l(rho=965.4, Psat=70.1E3, Pc=22120E3, mu=3.1472E-4, P1=680E3,
    ... P2=220E3, Q=0.1, D1=0.1, D2=0.1, d=0.95, FL=0.6, Fd=0.98)
    230.1734424266345

    Modified example 2 with laminar flow at 100x viscosity, 100th flow rate,
    and 1/10th diameters:

    >>> size_l(rho=965.4, Psat=70.1E3, Pc=22120E3, mu=3.1472E-2, P1=680E3,
    ... P2=220E3, Q=0.001, D1=0.01, D2=0.01, d=0.01, FL=0.6, Fd=0.98)
    3.0947562381723626
...
def size_g(T, MW, mu, gamma, Z, P1, P2, Q, D1, D2, d, FL, Fd, xT):
    ...
    >>> size_g(T=433., MW=44.01, mu=1.4665E-4, gamma=1.30, Z=0.988, P1=680E3,
    ...
    >>> size_g(T=320., MW=39.95, mu=5.625E-5, gamma=1.67, Z=1.0, P1=2.8E5,
    ... P2=1.3E5, Q=0.46/3600., D1=0.015, D2=0.015, d=0.015, FL=0.98, Fd=0.07,
    ... xT=0.8)
