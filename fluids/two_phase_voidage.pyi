...
def Beattie_Whalley(x: float, mul: float, mug: float, rhol: int, rhog: float) -> float: ...
...
def Duckler(x: float, mul: float, mug: float, rhol: int, rhog: float) -> float: ...


def Fauske(x: float, rhol: float, rhog: float) -> float: ...


def Fourar_Bories(x: float, mul: float, mug: float, rhol: int, rhog: float) -> float: ...
...
def density_two_phase(alpha: float, rhol: int, rhog: float) -> float: ...
...
def two_phase_voidage_experimental(rho_lg: float, rhol: int, rhog: float) -> float: ...
